    ...
    <div class="mb-5">
        <ul class="nav nav-pills nav-justified nav-pills-custom" id="myTab" role="tablist">
            ...
            <li class="nav-item dropdown" role="presentation">
                <a class="nav-link dropdown-toggle" href="#" id="iuranDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="fa-solid fa-receipt me-2"></i> Iuran
                </a>
                <ul class="dropdown-menu" aria-labelledby="iuranDropdown">
                    <li>
                        <a class="dropdown-item <?= ($active_tab == 'iuran') ? 'active' : '' ?>" href="?tab=iuran<?= !empty($searchTerm) ? '&search=' . urlencode($searchTerm) : '' ?>">
                            Iuran Kas
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item <?= ($active_tab == 'iuran17') ? 'active' : '' ?>" href="?tab=iuran17<?= !empty($searchTerm) ? '&search=' . urlencode($searchTerm) : '' ?>">
                            Iuran-17
                        </a>
                    </li>
                </ul>
